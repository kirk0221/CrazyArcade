...
public class Bazzi extends Character implements KeyListener{
	...
	public Bazzi(Screen screen, int playertype) { /*플레이어 타입을 전달받아, 해당 타입에 따라 키에 대한 동작이 다르도록 함*/
		...
		this.Bazzi_state = new Image[4][3];
		Image Bazzi_front = new ImageIcon(getClass().getClassLoader().getResource("bazzi_front.png")).getImage();
		Image Bazzi_front1 =new ImageIcon(getClass().getClassLoader().getResource("bazzi_front1.png")).getImage();
		Image Bazzi_front2 =new ImageIcon(getClass().getClassLoader().getResource("bazzi_front2.png")).getImage();
		Image Bazzi_back = new ImageIcon(getClass().getClassLoader().getResource("bazzi_back.png")).getImage();
		Image Bazzi_back1 = new ImageIcon(getClass().getClassLoader().getResource("bazzi_back1.png")).getImage();
		Image Bazzi_back2 = new ImageIcon(getClass().getClassLoader().getResource("bazzi_back2.png")).getImage();
		Image Bazzi_left = new ImageIcon(getClass().getClassLoader().getResource("bazzi_left.png")).getImage();
		Image Bazzi_left1 = new ImageIcon(getClass().getClassLoader().getResource("bazzi_left1.png")).getImage();
		Image Bazzi_left2 = new ImageIcon(getClass().getClassLoader().getResource("bazzi_left2.png")).getImage();
		Image Bazzi_right = new ImageIcon(getClass().getClassLoader().getResource("bazzi_right.png")).getImage();
		Image Bazzi_right1 =new ImageIcon(getClass().getClassLoader().getResource("bazzi_right1.png")).getImage();
		Image Bazzi_right2 = new ImageIcon(getClass().getClassLoader().getResource("bazzi_right2.png")).getImage();
		this.Bazzi_state[0][0] = Bazzi_front;
		this.Bazzi_state[0][1] = Bazzi_front1;
		this.Bazzi_state[0][2] = Bazzi_front2;
		this.Bazzi_state[1][0] = Bazzi_back;
		this.Bazzi_state[1][1] = Bazzi_back1;
		this.Bazzi_state[1][2] = Bazzi_back2;
		this.Bazzi_state[2][0] = Bazzi_left;
		this.Bazzi_state[2][1] = Bazzi_left1;
		this.Bazzi_state[2][2] = Bazzi_left2;
		this.Bazzi_state[3][0] = Bazzi_right;
		this.Bazzi_state[3][1] = Bazzi_right1;
		this.Bazzi_state[3][2] = Bazzi_right2;
	...
	public Image getImg() {//이미지를 스크린에 주기위한 함수
		return this.Bazzi_state[state][state_move];
	}
