...
public class Bazzi extends Character implements KeyListener{
	...
	public Bazzi(Screen screen, int playertype) { /*플레이어 타입을 전달받아, 해당 타입에 따라 키에 대한 동작이 다르도록 함*/
		...
		Image Bazzi_front = new ImageIcon("Resources/bazzi_front.png").getImage();//다오 정면 이미지
		Image Bazzi_front1 = new ImageIcon("Resources/bazzi_front1.png").getImage();
		Image Bazzi_front2 = new ImageIcon("Resources/bazzi_front2.png").getImage();
		Image Bazzi_back = new ImageIcon("Resources/bazzi_back.png").getImage();//다오 후면 이미지
		Image Bazzi_back1 = new ImageIcon("Resources/bazzi_back1.png").getImage();
		Image Bazzi_back2 = new ImageIcon("Resources/bazzi_back2.png").getImage();
		Image Bazzi_left = new ImageIcon("Resources/bazzi_left.png").getImage();//다오 좌측면 이미지
		Image Bazzi_left1 = new ImageIcon("Resources/bazzi_left1.png").getImage();
		Image Bazzi_left2 = new ImageIcon("Resources/bazzi_left2.png").getImage();
		Image Bazzi_right = new ImageIcon("Resources/bazzi_right.png").getImage();//다오 우측면 이미지
		Image Bazzi_right1 = new ImageIcon("Resources/bazzi_right1.png").getImage();
		Image Bazzi_right2 = new ImageIcon("Resources/bazzi_right2.png").getImage();
