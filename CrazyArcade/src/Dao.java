...
public class Dao extends Character implements KeyListener{
	...
	public Dao(Screen screen, int playertype) { /*플레이어 타입을 전달받아, 해당 타입에 따라 키에 대한 동작이 다르도록 함*/
		...
		this.Dao_state = new Image[4][3];
		Image dao_front = new ImageIcon(getClass().getClassLoader().getResource("dao_front.png")).getImage();//다오 정면 이미지
		Image dao_front1 = new ImageIcon(getClass().getClassLoader().getResource("dao_front1.png")).getImage();
		Image dao_front2 = new ImageIcon(getClass().getClassLoader().getResource("dao_front2.png")).getImage();
		Image dao_back = new ImageIcon(getClass().getClassLoader().getResource("dao_back.png")).getImage();//다오 후면 이미지
		Image dao_back1 = new ImageIcon(getClass().getClassLoader().getResource("dao_back1.png")).getImage();
		Image dao_back2 = new ImageIcon(getClass().getClassLoader().getResource("dao_back2.png")).getImage();
		Image dao_left = new ImageIcon(getClass().getClassLoader().getResource("dao_left.png")).getImage();//다오 좌측면 이미지
		Image dao_left1 = new ImageIcon(getClass().getClassLoader().getResource("dao_left1.png")).getImage();
		Image dao_left2 = new ImageIcon(getClass().getClassLoader().getResource("dao_left2.png")).getImage();
		Image dao_right = new ImageIcon(getClass().getClassLoader().getResource("dao_right.png")).getImage();//다오 우측면 이미지
		Image dao_right1 = new ImageIcon(getClass().getClassLoader().getResource("dao_right1.png")).getImage();
		Image dao_right2 = new ImageIcon(getClass().getClassLoader().getResource("dao_right2.png")).getImage();
		this.Dao_state[0][0] = dao_front;
		this.Dao_state[0][1] = dao_front1;
		this.Dao_state[0][2] = dao_front2;
		this.Dao_state[1][0] = dao_back;
		this.Dao_state[1][1] = dao_back1;
		this.Dao_state[1][2] = dao_back2;
		this.Dao_state[2][0] = dao_left;
		this.Dao_state[2][1] = dao_left1;
		this.Dao_state[2][2] = dao_left2;
		this.Dao_state[3][0] = dao_right;
		this.Dao_state[3][1] = dao_right1;
		this.Dao_state[3][2] = dao_right2;
	...
	public Image getImg() {//이미지를 스크린에 주기위한 함수
		return this.Dao_state[state][state_move];
	}
