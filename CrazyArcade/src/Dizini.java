...
public class Dizini extends Character implements KeyListener{
	...
	public Dizini(Screen screen, int playertype) { /*플레이어 타입을 전달받아, 해당 타입에 따라 키에 대한 동작이 다르도록 함*/
		...
		this.Dizini_state = new Image[4][3];
		Image Dizini_front = new ImageIcon(getClass().getClassLoader().getResource("dizini_front.png")).getImage();//다오 정면 이미지
		Image Dizini_front1 = new ImageIcon(getClass().getClassLoader().getResource("dizini_front1.png")).getImage();
		Image Dizini_front2 = new ImageIcon(getClass().getClassLoader().getResource("dizini_front2.png")).getImage();
		Image Dizini_back = new ImageIcon(getClass().getClassLoader().getResource("dizini_back.png")).getImage();//다오 후면 이미지
		Image Dizini_back1 = new ImageIcon(getClass().getClassLoader().getResource("dizini_back1.png")).getImage();
		Image Dizini_back2 = new ImageIcon(getClass().getClassLoader().getResource("dizini_back2.png")).getImage();
		Image Dizini_left = new ImageIcon(getClass().getClassLoader().getResource("dizini_left.png")).getImage();//다오 좌측면 이미지
		Image Dizini_left1 = new ImageIcon(getClass().getClassLoader().getResource("dizini_left1.png")).getImage();
		Image Dizini_left2 = new ImageIcon(getClass().getClassLoader().getResource("dizini_left2.png")).getImage();
		Image Dizini_right = new ImageIcon(getClass().getClassLoader().getResource("dizini_right.png")).getImage();//다오 우측면 이미지
		Image Dizini_right1 = new ImageIcon(getClass().getClassLoader().getResource("dizini_right1.png")).getImage();
		Image Dizini_right2 = new ImageIcon(getClass().getClassLoader().getResource("dizini_right2.png")).getImage();
		this.Dizini_state[0][0] = Dizini_front;
		this.Dizini_state[0][1] = Dizini_front1;
		this.Dizini_state[0][2] = Dizini_front2;
		this.Dizini_state[1][0] = Dizini_back;
		this.Dizini_state[1][1] = Dizini_back1;
		this.Dizini_state[1][2] = Dizini_back2;
		this.Dizini_state[2][0] = Dizini_left;
		this.Dizini_state[2][1] = Dizini_left1;
		this.Dizini_state[2][2] = Dizini_left2;
		this.Dizini_state[3][0] = Dizini_right;
		this.Dizini_state[3][1] = Dizini_right1;
		this.Dizini_state[3][2] = Dizini_right2;
	...
	public Image getImg() {//이미지를 스크린에 주기위한 함수
		return this.Dizini_state[state][state_move];
	}
