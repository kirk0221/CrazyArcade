...
public class Dizini extends Character implements KeyListener{
	...
	public Dizini(Screen screen, int playertype) { /*플레이어 타입을 전달받아, 해당 타입에 따라 키에 대한 동작이 다르도록 함*/
		...
		Image Dizini_front = new ImageIcon("Resources/dizini_front.png").getImage();//다오 정면 이미지
		Image Dizini_front1 = new ImageIcon("Resources/dizini_front1.png").getImage();
		Image Dizini_front2 = new ImageIcon("Resources/dizini_front2.png").getImage();
		Image Dizini_back = new ImageIcon("Resources/dizini_back.png").getImage();//다오 후면 이미지
		Image Dizini_back1 = new ImageIcon("Resources/dizini_back1.png").getImage();
		Image Dizini_back2 = new ImageIcon("Resources/dizini_back2.png").getImage();
		Image Dizini_left = new ImageIcon("Resources/dizini_left.png").getImage();//다오 좌측면 이미지
		Image Dizini_left1 = new ImageIcon("Resources/dizini_left1.png").getImage();
		Image Dizini_left2 = new ImageIcon("Resources/dizini_left2.png").getImage();
		Image Dizini_right = new ImageIcon("Resources/dizini_right.png").getImage();//다오 우측면 이미지
		Image Dizini_right1 = new ImageIcon("Resources/dizini_right1.png").getImage();
		Image Dizini_right2 = new ImageIcon("Resources/dizini_right2.png").getImage();
