...
public class Eddi extends Character implements KeyListener{
	...
	public Eddi(Screen screen, int playertype) { /*플레이어 타입을 전달받아, 해당 타입에 따라 키에 대한 동작이 다르도록 함*/
		...
		Image Eddi_front = new ImageIcon(getClass().getClassLoader().getResource("Eddi_front.png")).getImage();//다오 정면 이미지
		Image Eddi_front1 = new ImageIcon(getClass().getClassLoader().getResource("Eddi_front1.png")).getImage();
		Image Eddi_front2 = new ImageIcon(getClass().getClassLoader().getResource("Eddi_front2.png")).getImage();
		Image Eddi_back = new ImageIcon(getClass().getClassLoader().getResource("Eddi_back.png")).getImage();//다오 후면 이미지
		Image Eddi_back1 = new ImageIcon(getClass().getClassLoader().getResource("Eddi_back1.png")).getImage();
		Image Eddi_back2 = new ImageIcon(getClass().getClassLoader().getResource("Eddi_back2.png")).getImage();
		Image Eddi_left = new ImageIcon(getClass().getClassLoader().getResource("Eddi_left.png")).getImage();//다오 좌측면 이미지
		Image Eddi_left1 =new ImageIcon(getClass().getClassLoader().getResource("Eddi_left1.png")).getImage();
		Image Eddi_left2 = new ImageIcon(getClass().getClassLoader().getResource("Eddi_left2.png")).getImage();
		Image Eddi_right = new ImageIcon(getClass().getClassLoader().getResource("Eddi_right.png")).getImage();//다오 우측면 이미지
		Image Eddi_right1 = new ImageIcon(getClass().getClassLoader().getResource("Eddi_right1.png")).getImage();
		Image Eddi_right2 = new ImageIcon(getClass().getClassLoader().getResource("Eddi_right2.png")).getImage();
