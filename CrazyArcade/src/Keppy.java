...
public class Keppy extends Character implements KeyListener{
	...
	public Keppy(Screen screen, int playertype) { /*플레이어 타입을 전달받아, 해당 타입에 따라 키에 대한 동작이 다르도록 함*/
		super(screen);
		...
		this.Keppy_state = new Image[4][3];
		Image Keppy_front = new ImageIcon(getClass().getClassLoader().getResource("Keppi_front.png")).getImage();
		Image Keppy_front1 = new ImageIcon(getClass().getClassLoader().getResource("Keppi_front1.png")).getImage();
		Image Keppy_front2 = new ImageIcon(getClass().getClassLoader().getResource("Keppi_front2.png")).getImage();
		Image Keppy_back = new ImageIcon(getClass().getClassLoader().getResource("Keppi_back.png")).getImage();
		Image Keppy_back1 = new ImageIcon(getClass().getClassLoader().getResource("Keppi_back1.png")).getImage();
		Image Keppy_back2 = new ImageIcon(getClass().getClassLoader().getResource("Keppi_back2.png")).getImage();
		Image Keppy_left =new ImageIcon(getClass().getClassLoader().getResource("Keppi_left.png")).getImage();//다오 좌측면 이미지
		Image Keppy_left1 = new ImageIcon(getClass().getClassLoader().getResource("Keppi_left1.png")).getImage();
		Image Keppy_left2 = new ImageIcon(getClass().getClassLoader().getResource("Keppi_left2.png")).getImage();
		Image Keppy_right = new ImageIcon(getClass().getClassLoader().getResource("Keppi_right.png")).getImage();//다오 우측면 이미지
		Image Keppy_right1 = new ImageIcon(getClass().getClassLoader().getResource("Keppi_right1.png")).getImage();
		Image Keppy_right2 = new ImageIcon(getClass().getClassLoader().getResource("Keppi_right2.png")).getImage();
		this.Keppy_state[0][0] = Keppy_front;
		this.Keppy_state[0][1] = Keppy_front1;
		this.Keppy_state[0][2] = Keppy_front2;
		this.Keppy_state[1][0] = Keppy_back;
		this.Keppy_state[1][1] = Keppy_back1;
		this.Keppy_state[1][2] = Keppy_back2;
		this.Keppy_state[2][0] = Keppy_left;
		this.Keppy_state[2][1] = Keppy_left1;
		this.Keppy_state[2][2] = Keppy_left2;
		this.Keppy_state[3][0] = Keppy_right;
		this.Keppy_state[3][1] = Keppy_right1;
		this.Keppy_state[3][2] = Keppy_right2;
	...
	public Image getImg() {//이미지를 스크린에 주기위한 함수
		return this.Keppy_state[state][state_move];
	}
