...
public class Keppy extends Character implements KeyListener{
	...
	public Keppy(Screen screen, int playertype) { /*플레이어 타입을 전달받아, 해당 타입에 따라 키에 대한 동작이 다르도록 함*/
		...
		Image Keppy_front = new ImageIcon("Resources/Keppi_front.png").getImage();//다오 정면 이미지
		Image Keppy_front1 = new ImageIcon("Resources/Keppi_front1.png").getImage();
		Image Keppy_front2 = new ImageIcon("Resources/Keppi_front2.png").getImage();
		Image Keppy_back = new ImageIcon("Resources/Keppi_back.png").getImage();//다오 후면 이미지
		Image Keppy_back1 = new ImageIcon("Resources/Keppi_back1.png").getImage();
		Image Keppy_back2 = new ImageIcon("Resources/Keppi_back2.png").getImage();
		Image Keppy_left = new ImageIcon("Resources/Keppi_left.png").getImage();//다오 좌측면 이미지
		Image Keppy_left1 = new ImageIcon("Resources/Keppi_left1.png").getImage();
		Image Keppy_left2 = new ImageIcon("Resources/Keppi_left2.png").getImage();
		Image Keppy_right = new ImageIcon("Resources/Keppi_right.png").getImage();//다오 우측면 이미지
		Image Keppy_right1 = new ImageIcon("Resources/Keppi_right1.png").getImage();
		Image Keppy_right2 = new ImageIcon("Resources/Keppi_right2.png").getImage();
