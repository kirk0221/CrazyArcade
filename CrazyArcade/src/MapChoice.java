...
public class MapChoice extends JFrame implements ActionListener{
	...
	private JPanel centerPanel() { //창 가운데 들어갈 패널(맵 선택)
		...
		Forest.setPreferredSize(new Dimension(100,100)); //빌리지 버튼 크기 100,100 설정
		
		Cookie.addActionListener(new ActionListener() {//쿠키(맵0) 선택시
			@Override
		...
		Patriots.addActionListener(new ActionListener() {//해적(맵1) 선택시
			@Override
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
		...
		Forest.addActionListener(new ActionListener() {//숲(맵2) 선택시
			@Override
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
