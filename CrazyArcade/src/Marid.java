...
public class Marid extends Character implements KeyListener{
	...
	public Marid(Screen screen, int playertype) { /*플레이어 타입을 전달받아, 해당 타입에 따라 키에 대한 동작이 다르도록 함*/
		...
		Image Marid_front = new ImageIcon("Resources/Marid_front.png").getImage();//다오 정면 이미지
		Image Marid_front1 = new ImageIcon("Resources/Marid_front1.png").getImage();
		Image Marid_front2 = new ImageIcon("Resources/Marid_front2.png").getImage();
		Image Marid_back = new ImageIcon("Resources/Marid_back.png").getImage();//다오 후면 이미지
		Image Marid_back1 = new ImageIcon("Resources/Marid_back1.png").getImage();
		Image Marid_back2 = new ImageIcon("Resources/Marid_back2.png").getImage();
		Image Marid_left = new ImageIcon("Resources/Marid_left.png").getImage();//다오 좌측면 이미지
		Image Marid_left1 = new ImageIcon("Resources/Marid_left1.png").getImage();
		Image Marid_left2 = new ImageIcon("Resources/Marid_left2.png").getImage();
		Image Marid_right = new ImageIcon("Resources/Marid_right.png").getImage();//다오 우측면 이미지
		Image Marid_right1 = new ImageIcon("Resources/Marid_right1.png").getImage();
		Image Marid_right2 = new ImageIcon("Resources/Marid_right2.png").getImage();
