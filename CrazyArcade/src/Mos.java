...
public class Mos extends Character implements KeyListener{
	...
	public Mos(Screen screen, int playertype) { /*플레이어 타입을 전달받아, 해당 타입에 따라 키에 대한 동작이 다르도록 함*/
		...
		Image Mos_front = new ImageIcon("Resources/mos_front.png").getImage();//다오 정면 이미지
		Image Mos_front1 = new ImageIcon("Resources/mos_front1.png").getImage();
		Image Mos_front2 = new ImageIcon("Resources/mos_front2.png").getImage();
		Image Mos_back = new ImageIcon("Resources/mos_back.png").getImage();//다오 후면 이미지
		Image Mos_back1 = new ImageIcon("Resources/mos_back1.png").getImage();
		Image Mos_back2 = new ImageIcon("Resources/mos_back2.png").getImage();
		Image Mos_left = new ImageIcon("Resources/mos_left.png").getImage();//다오 좌측면 이미지
		Image Mos_left1 = new ImageIcon("Resources/mos_left1.png").getImage();
		Image Mos_left2 = new ImageIcon("Resources/mos_left2.png").getImage();
		Image Mos_right = new ImageIcon("Resources/mos_right.png").getImage();//다오 우측면 이미지
		Image Mos_right1 = new ImageIcon("Resources/mos_right1.png").getImage();
		Image Mos_right2 = new ImageIcon("Resources/mos_right2.png").getImage();
