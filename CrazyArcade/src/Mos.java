...
public class Mos extends Character implements KeyListener{
	...
	public Mos(Screen screen, int playertype) { /*플레이어 타입을 전달받아, 해당 타입에 따라 키에 대한 동작이 다르도록 함*/
		...
		this.Mos_state = new Image[4][3];
		Image Mos_front = new ImageIcon(getClass().getClassLoader().getResource("mos_front.png")).getImage();//다오 정면 이미지
		Image Mos_front1 =new ImageIcon(getClass().getClassLoader().getResource("mos_front1.png")).getImage();
		Image Mos_front2 = new ImageIcon(getClass().getClassLoader().getResource("mos_front2.png")).getImage();
		Image Mos_back = new ImageIcon(getClass().getClassLoader().getResource("mos_back.png")).getImage();//다오 후면 이미지
		Image Mos_back1 = new ImageIcon(getClass().getClassLoader().getResource("mos_back1.png")).getImage();
		Image Mos_back2 = new ImageIcon(getClass().getClassLoader().getResource("mos_back2.png")).getImage();
		Image Mos_left = new ImageIcon(getClass().getClassLoader().getResource("mos_left.png")).getImage();//다오 좌측면 이미지
		Image Mos_left1 =new ImageIcon(getClass().getClassLoader().getResource("mos_left1.png")).getImage();
		Image Mos_left2 = new ImageIcon(getClass().getClassLoader().getResource("mos_left2.png")).getImage();
		Image Mos_right = new ImageIcon(getClass().getClassLoader().getResource("mos_right.png")).getImage();//다오 우측면 이미지
		Image Mos_right1 = new ImageIcon(getClass().getClassLoader().getResource("mos_right1.png")).getImage();
		Image Mos_right2 = new ImageIcon(getClass().getClassLoader().getResource("mos_right2.png")).getImage();
		this.Mos_state[0][0] = Mos_front;
		this.Mos_state[0][1] = Mos_front1;
		this.Mos_state[0][2] = Mos_front2;
		this.Mos_state[1][0] = Mos_back;
		this.Mos_state[1][1] = Mos_back1;
		this.Mos_state[1][2] = Mos_back2;
		this.Mos_state[2][0] = Mos_left;
		this.Mos_state[2][1] = Mos_left1;
		this.Mos_state[2][2] = Mos_left2;
		this.Mos_state[3][0] = Mos_right;
		this.Mos_state[3][1] = Mos_right1;
		this.Mos_state[3][2] = Mos_right2;
	...
	public Image getImg() {//이미지를 스크린에 주기위한 함수
		return this.Mos_state[state][state_move];
	}
