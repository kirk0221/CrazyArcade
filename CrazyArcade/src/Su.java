...
public class Su extends Character implements KeyListener{
	...
	public Su(Screen screen, int playertype) { /*플레이어 타입을 전달받아, 해당 타입에 따라 키에 대한 동작이 다르도록 함*/
		...
		Image Su_front = new ImageIcon(getClass().getClassLoader().getResource("Su_front.png")).getImage();//다오 정면 이미지
		Image Su_front1 = new ImageIcon(getClass().getClassLoader().getResource("Su_front1.png")).getImage();
		Image Su_front2 = new ImageIcon(getClass().getClassLoader().getResource("Su_front2.png")).getImage();
		Image Su_back = new ImageIcon(getClass().getClassLoader().getResource("Su_back.png")).getImage();//다오 후면 이미지
		Image Su_back1 = new ImageIcon(getClass().getClassLoader().getResource("Su_back1.png")).getImage();
		Image Su_back2 = new ImageIcon(getClass().getClassLoader().getResource("Su_back2.png")).getImage();
		Image Su_left = new ImageIcon(getClass().getClassLoader().getResource("Su_left.png")).getImage();//다오 좌측면 이미지
		Image Su_left1 = new ImageIcon(getClass().getClassLoader().getResource("Su_left1.png")).getImage();
		Image Su_left2 = new ImageIcon(getClass().getClassLoader().getResource("Su_left2.png")).getImage();
		Image Su_right = new ImageIcon(getClass().getClassLoader().getResource("Su_right.png")).getImage();//다오 우측면 이미지
		Image Su_right1 = new ImageIcon(getClass().getClassLoader().getResource("Su_right1.png")).getImage();
		Image Su_right2 = new ImageIcon(getClass().getClassLoader().getResource("Su_right2.png")).getImage();
